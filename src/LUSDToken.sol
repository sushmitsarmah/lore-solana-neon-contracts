...
contract LUSDToken is CheckContract, ILUSDToken {
    ...
    // --- Events ---
    // TroveManagerAddressChanged, StabilityPoolAddressChanged, BorrowerOperationsAddressChanged are inherited from ILUSDToken
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        ...
        _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount); // Using '-' instead of sub, check for underflow handled by Solidity 0.8+
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) external override returns (bool) {
        _approve(msg.sender, spender, _allowances[msg.sender][spender] - subtractedValue); // Using '-' instead of sub, check for underflow handled by Solidity 0.8+
        return true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        _balances[sender] = _balances[sender] - amount; // Using '-' instead of sub, check for underflow handled by Solidity 0.8+
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        _balances[account] = _balances[account] - amount; // Using '-' instead of sub, check for underflow handled by Solidity 0.8+
        _totalSupply = _totalSupply - amount;
